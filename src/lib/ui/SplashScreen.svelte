    ...
    <div class="container has-text-centered">
      <div class="columns is-vcentered">
        <div class="column is-5">
          <figure class="image">
            <img class="object-fit" src="/note-img.gif" alt="bouncing note logo" />
          </figure>
        </div>
        <div class="column is-6 is-offset-1">
          <h1 class="title is-2 mb-5">
            <span class="icon mr-5"><i style="font-size: 48px; color: darkorange;" class="fas fa-guitar"></i></span>
            <p>PlaceMark</p>
          </h1>
          <h2 class="subtitle is-4 mt-2">Organise Venues & Events</h2>
